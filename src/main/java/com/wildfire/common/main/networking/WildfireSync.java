...
public class WildfireSync {
     ...
     */
    public static void sendToOtherClients(EntityPlayerMP toSync, GenderPlayer genderPlayer) {
     ...
     *
     * @param sendTo The {@link EntityPlayerMP player} to send the sync to
     * @param toSync The {@link GenderPlayer configuration} for the player being synced
     */
    public static void sendToClient(EntityPlayerMP sendTo, GenderPlayer toSync) {
    ...
    private static void sendPacketToClient(EntityPlayerMP sendTo, PacketSync packet) {
        if (!(sendTo instanceof FakePlayer)) {

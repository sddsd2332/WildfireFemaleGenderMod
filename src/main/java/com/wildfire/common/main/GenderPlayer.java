...
public class GenderPlayer {
    ...
    public enum Gender {
        FEMALE(ChatFormatting.LIGHT_PURPLE + I18n.translateToLocal("wildfire_gender.label.female"), true, WildfireSounds.FEMALE_HURT),
        MALE(ChatFormatting.BLUE + I18n.translateToLocal("wildfire_gender.label.male"), false, null),
        OTHER(ChatFormatting.GREEN + I18n.translateToLocal("wildfire_gender.label.other"), true, null);
        ...
        Gender(String name, boolean canHaveBreasts, @Nullable SoundEvent hurtSound) {
            this.name = name;
